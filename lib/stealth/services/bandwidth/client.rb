...
#           @reply = reply
#           bandwidth = Stealth.configurations[:bandwidth]
#           account_id = bandwidth.account_id
#           username = bandwidth.api_username
#           password = bandwidth.api_password
#           application_id = bandwidth.application_id
